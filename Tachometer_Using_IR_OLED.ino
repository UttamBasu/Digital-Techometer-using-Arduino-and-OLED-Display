/*
  ...
  On this sketch I am going to measure the period between pulses using the micros() function to get the RPM
  ...
  I use an interrupt for the input so you have to choose pin 2 or 3 (for Arduino Uno/nano).
  In this example I use pin 2.

  OLED 0.96" Display-
  I am going to use the OLED 128x64 I2C with SSD1306 driver using the Adafruit library.
  ...
  This sketch was made by Uttam Basu
  Follow Me-https://github.com/UttamBasu
*/
